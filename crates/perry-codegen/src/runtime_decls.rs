...
pub fn declare_phase_b_strings(module: &mut LlModule) {
    ...
    module.declare_function("js_array_is_array", DOUBLE, &[DOUBLE]);    module.declare_function("js_set_alloc", I64, &[I32]);
    ...
    module.declare_function("js_string_last_index_of_from", I32, &[I64, I64, I32]);
